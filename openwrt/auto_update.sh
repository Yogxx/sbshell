...
while true; do
    echo -e "${CYAN}Please select an operation:${NC}"
    echo "1. Set the automatic update interval"
    echo "2. Cancel automatic renewal"
    read -rp "Please enter options (1 or 2, Default is 1): " menu_choice
    menu_choice=${menu_choice:-1}

    if [[ "$menu_choice" == "1" ]]; then
        while true; do
            read -rp "Please enter the number of hours between updates (1-23 hours, default is 12 hours): " interval_choice
